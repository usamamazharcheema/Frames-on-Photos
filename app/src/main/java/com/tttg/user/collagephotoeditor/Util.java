...
public class Util {
    ...
    /**
     * parameter beard02 is contain in parameter beard01.
     *
     * @param sourceFlag
     * @param compareFlag
     * @return
    ...
    /**
     * update the isSDCardAvailable fashion isSDCardWriteable state
     */
    ...
    public static final void openGPS(Context context) {
        ...
        GPSIntent.setData(Uri.parse("custom:beard03"));
        try {
